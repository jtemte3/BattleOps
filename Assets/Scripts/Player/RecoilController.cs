...
public class RecoilController : MonoBehaviour
{
    ...
    public void ApplyRecoil()
    {
        ...
        cameraParent.transform.localRotation = Quaternion.Euler(-currentCameraRecoil.x + swayController.GetSwayRotation().x, currentCameraRecoil.y + swayController.GetSwayRotation().y, swayController.GetSwayRotation().z);
