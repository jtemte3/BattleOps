...
public static class RoadMeshBuilder
{
    ...
    public static void BuildRoadMesh(List<Vector3> splinePoints, int roadId, float roadGroundOffset, float roadWidth, float roadThickness, float uvScale, Material roadMaterial, Transform parent)
    {
        ...
        for (int i = 0; i < splinePoints.Count; i++)
        {
            ...
            Vector3 v0 = splinePoints[i] + left * -roadWidth - Vector3.up * roadThickness + heightOffset + parent.position; // bottom left
            Vector3 v1 = splinePoints[i] + left * roadWidth - Vector3.up * roadThickness + heightOffset + parent.position;  // bottom right
            Vector3 v2 = splinePoints[i] + left * -roadWidth + Vector3.up * roadThickness + heightOffset + parent.position; // top left
            Vector3 v3 = splinePoints[i] + left * roadWidth + Vector3.up * roadThickness + heightOffset + parent.position;  // top right
    ...
    public static GameObject BuildRoadPathMesh(List<Vector3> splinePoints, float roadWidth, float roadThickness, float uvScale, Material roadMaterial, Transform parent)
    {
        var verts = new List<Vector3>();
        var tris = new List<int>();
        var uvs = new List<Vector2>();
        ...
        for (int i = 0; i < splinePoints.Count; i++)
        {
            ...
            // Build ring of 4 verts (top-left, top-right, bottom-left, bottom-right)
            Vector3 v0 = splinePoints[i] + left * -roadWidth - Vector3.up * roadThickness; // bottom left
            Vector3 v1 = splinePoints[i] + left * roadWidth - Vector3.up * roadThickness;  // bottom right
            Vector3 v2 = splinePoints[i] + left * -roadWidth + Vector3.up * roadThickness; // top left
            Vector3 v3 = splinePoints[i] + left * roadWidth + Vector3.up * roadThickness;  // top right
    ...
    public static void BuildIntersectionCylinder(Vector3 position, int id, float roadGroundOffset, float roadWidth, float roadThickness, float uvScale, Material roadMaterial, Transform parent)
    {
        ...
        for (int i = 0; i < segments; i++)
        {
            ...
            Vector3 top = new Vector3(x, halfH, z) + position + offset + parent.position;
            Vector3 bottom = new Vector3(x, -halfH, z) + position + offset + parent.position;
        ...
        Vector3 topC = new Vector3(0, -halfH, 0) + position + offset + parent.position;
        verts.Add(topC);
        ...
        Vector3 botC = new Vector3(0, halfH, 0) + position + offset + parent.position;
        verts.Add(botC);
    ...
    public static GameObject BuildRoadPathIntersections(Vector3 position, int id, float roadWidth, float roadThickness, float uvScale, Material roadMaterial, Transform parent)
    {
        int segments = 32;
        float radius = roadWidth;
        float halfH = roadThickness - .001f;
        ...
        for (int i = 0; i < segments; i++)
        {
            ...
            Vector3 top = new Vector3(x, halfH, z) + position;
            Vector3 bottom = new Vector3(x, -halfH, z) + position;
        ...
        int topCenter = verts.Count;
        Vector3 topC = new Vector3(0, -halfH, 0) + position;
        verts.Add(topC);
        uvs.Add(new Vector2(topC.x * uvScale, -topC.z * uvScale));
        ...
        int botCenter = verts.Count;
        Vector3 botC = new Vector3(0, halfH, 0) + position;
        verts.Add(botC);
        uvs.Add(new Vector2(botC.x * uvScale, -botC.z * uvScale));
